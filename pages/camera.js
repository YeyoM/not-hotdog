    ...
    <div className='flex flex-row min-h-screen w-full items-center justify-center bg'>
      ...
      <div className='block fixed h-24 inset-x-0 bottom-0 z-10 bg-black'>
        <div className='flex justify-center h-full items-center'>
          {
            isMobile
            ? <button className="menu-btn absolute left-5 top-6 z-0 text-xl  cursor-pointer transition-all duration-500 ease-in-out text-white items-center" onClick={changeCamera}>
          ...
          <div className='justify-center inline-block text-center items-center'>
            ...
            <div className="results fixed flex flex-col justify-center overflow-hidden top-0 right-[-100%] h-screen w-full transition-all duration-500 ease-in-out items-center">
              <div className='h-fit md:p-12 sm:p-4 xl:top-0 top-8 max-w-2xl justify-center overflow-hidden flex flex-col text-black bg-gray-100 rounded-md bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-40 border border-black'>
                <h2 className="text-4xl p-4 mb-1 font-bold mt-12">
                  {imageSrc ? 'Is your picture a Hot Dog?' : 'No Photo Taken'}
                </h2>
                <p className="text-xl font-semibold mb-1 p-4">
                ...
                <div className="max-h-1/4 p-10 mb-8 rounded-lg">
                  {
                    ...
                    ? <img src={imageSrc} className='object-scale-down rounded-xl' alt=""/>
                    : null
                  }
                </div>
              </div>
